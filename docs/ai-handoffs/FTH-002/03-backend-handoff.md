...
| FTH-002-BDD-007 | Customer, Application e OutboxMessage usam um único SaveChangesAsync | critical | inspeção estática do handler e unit of work | manual | `src/backend/FundoTakeHome.Api/Features/SubmitApplication/Application/SubmitApplicationHandler.cs::HandleAsync` | covered | Há uma chamada literal a `SaveChangesAsync` após os adds/updates. |
...
- **Momento:** pré-Infra
- **Mapa:** `ApprovedApplicationStore` = Features/SubmitApplication/Infrastructure/Persistence; `OutboxMessage` = Features/SubmitApplication/Infrastructure/Persistence/Outbox; consumidores: somente o use case aprovado.
- **Q:** OK
...
- **Arquivos:** `Infrastructure/Persistence/FundoTakeHomeDbContext.cs`, `Features/SubmitApplication/Infrastructure/Persistence/ApprovedApplicationStore.cs`, `Features/SubmitApplication/Infrastructure/Persistence/Outbox/OutboxMessage.cs`.
...
- `ApprovedApplicationEvent` está em `Features/SubmitApplication/Infrastructure/Persistence/Outbox/`.
